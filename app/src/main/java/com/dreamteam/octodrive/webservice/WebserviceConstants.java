...
public class WebserviceConstants {
    public final static String kPARSE_APPLICATION_ID = "T6Th1zGR4AaDEwVW3tPizPNDvLsJVmeNzldKmEe3";
    public final static String kPARSE_CLIENT_KEY = "HABeX061WyGNKvodMh2ctTKiq4CY14ls2oDwN31T";

    public final static String kPARSE_PROPERTY_OBJECT_ID = "objectId";

    public final static String kPARSE_OBJECT_USER = "_User";
